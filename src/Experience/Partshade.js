...
export default class Partshade {
  ...
  setUpGradientBackground() {
    // this.firstPallete = ["#222831", "#393E46", "#00ADB5", "#EEEEEE", "#000000"];

    this.pallete = [
      new THREE.Color("#5d7343"),
      new THREE.Color("#3a5731"),
      new THREE.Color("#50623a"),
      new THREE.Color("#50623a"),
      new THREE.Color("#000000"),
    ];

    // this.thirdPallete = [
    //   new THREE.Color("#2C6E63"),
    //   new THREE.Color("#FBE5B6"),
    //   new THREE.Color("#2C6E63"),
    //   new THREE.Color("#F38218"),
    //   new THREE.Color("#2C6E63"),
    // ];

    // this.fourthPallete = [
    //   new THREE.Color("#D04848"),
    //   new THREE.Color("#D04848"),
    //   new THREE.Color("#6895D2"),
    //   new THREE.Color("#FDE767"),
    //   new THREE.Color("#6895D2"),
    // ];

    // this.firstPallete = this.firstPallete.map(
